...
class DQN_DouDiZhu:
    ...
    def createQNetwork(self):
        ...
        weights = {
            ...
            'W_fc8': tf.Variable(tf.truncated_normal([4096, self.ACTION_NUM], stddev=0.02), trainable=True,
                                 name='W_fc8')
        }
        ...
        with tf.name_scope('fc8'):
            self.QValue = tf.add(tf.matmul(drop7, weights['W_fc8']), biases['b_fc8'], name='fc8')
